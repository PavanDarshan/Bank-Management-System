...
class BankBusinessService {
   ...
   public void withdraw(int accNo , double amount){
    ...
    public void generateStatement(int accNo,int password) {
        try {
            ...
            if(accountNumValidation(accNo,password)) {
                while (result.next()) {
                ...
                ResultSet rs = accountValidationAndDetails.getAccountDetails(accNo,password, connection);
    ...
    public boolean accountNumValidation(int accNo,int password) {
        try {
            Connection connection = getConnection.getconnection();
