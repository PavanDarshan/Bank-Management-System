            ...
            do {
                ...
                switch (choice) {
                    case 1:
                        ...
                        if(console!=null){
                           pw= console.readPassword("Enter the Password :\n");
                        }
                         password=Integer.parseInt(new String(pw));


                        //Account Validation
                        if(accNo>1000 && BS1.accountNumValidation(accNo,password)){
                    ...
                    case 2:
                        ...
                        //Account Validation
                        if (accNo>1000 && BS2.accountNumValidation(accNo,password)) {
                    ...
                    case 3:
                        ...
                        if(accNo>1000 && BS3.accountNumValidation(accNo,password))
                    ...
                    case 4:
                        ...
                        //Account Validation
                       if(accNo>1000 && BS4.accountNumValidation(accNo,password)) BS4.generateStatement(accNo,password);
                       else System.out.println("INVALID ACCOUNT NUMBER");
                        System.out.print("Do You Want to continue...\npress Y/y => YES or N/n => NO  ");
